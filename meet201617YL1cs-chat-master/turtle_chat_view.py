...
class View:
    ...
    def __init__(self,username='Me',partner_name='Partner',):
        ...
        ###
        self.t1=self.text.writer.clone()
        self.t1.goto(-100,50)
        self.t2=self.text.writer.clone()
        self.t2.goto(-100,100)
    ...
    def send_msg(self):
        ...
        '''
        self.my_client.send(self.text.new_msg)
        self.msg_queue.append(self.text.new_msg)
        self.text.clear_msg()
        self.display_msg()
...
if __name__ == '__main__':
    ...
    def check() :
        ...
        msg_in=view.get_client().receive()
        if not(msg_in is None):
            if msg_in==Client._END_MSG:
                print('End message received')
                sys.exit()
            else:
                view.msg_received(msg_in)
